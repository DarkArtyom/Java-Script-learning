...
//     const countFriends = [...users].sort ((a,b)=> a.friends.length - b.friends.length).map(user => user.name);
// return countFriends
// };
// // Change code above this line

// getNamesSortedByFriendCount(usersLength);
